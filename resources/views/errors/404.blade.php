            ...
            <div class="row full-height-vh">
                <div class="col-md-12 col-lg-3 ml-auto d-flex align-items-center">
                    <div class="row text-center mb-3">
                        <div class="col-12">
                            <img src="admin_asset/app-assets/img/portrait/avatars/avatar-10.png" alt="User" width="300">
                        </div>
                        <div class="col-12">
                            ...
                            <!-- <fieldset class="row py-2">
                                <div class="input-group col-12">
                                    ...
                                    <div class="input-group-append">
                                        <a class="input-group-text" id="basic-addon2"><i class="ft-search"></i></a>
                                    </div>
                                </div>
                            </fieldset> -->
                            <div class="row py-2 justify-content-center">
                            	Nội dung truy cập không phù hợp!
                            </div>
                            <div class="row py-2 justify-content-center">
                                <div class="col-8">
                        ...
                        <div class="error-footer bg-transparent">
                            <div class="row">
                                ...
                                <div class="col-12 text-center">
                                    <a class="btn btn-social-icon mr-1 mb-1 btn-facebook" href="https://www.facebook.com/DHCNSG/">
