        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">XÓA NHÓM SẢN PHẨM <a style="color: tomato">{{ $sanpham->tensp }}</a></h4>
                </div>
                <div class="card-body collapse show">
                    <div class="card-block card-dashboard">
                      @if(count($errors)>0)
                        ...
                        @endif
                      <strong>Lưu ý!</strong>
                      <p>Hệ thống sẽ xóa sản phẩm này.</p>
                      <p>Bạn có chắc chắn muốn xóa?</p>

                      <form class="form" action="admin/sanpham/xoa/{{ $sanpham->id }}" method="POST">
