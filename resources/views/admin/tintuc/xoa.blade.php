        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">XÓA TIN TỨC <a style="color: tomato">{{ $tintuc->tieude }}</a></h4>
                </div>
                <div class="card-body collapse show">
                    <div class="card-block card-dashboard">
                      @if(count($errors)>0)
                        ...
                        @endif
                      <strong>Lưu ý!</strong>
                      <p>Hệ thống sẽ xóa tin tức này.</p>
                      <p>Bạn có chắc chắn muốn xóa?</p>

                      <form class="form" action="admin/tintuc/xoa/{{ $tintuc->id }}" method="POST">
