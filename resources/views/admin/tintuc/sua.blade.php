		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-tooltip">Sửa - {{ $tintuc->tensp }}</h4>
						...
						<form action="admin/tintuc/sua/{{ $tintuc->id }}" method="POST" enctype="multipart/form-data">
							...
							<div class="form-body">
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<select id="projectinput5" name="txtLoaitin" class="form-control">	
												...
												<option
													@if($row->id == $tintuc->id_loaitin)
														selected=""
													@endif
												value="{{ $row->id }}">{{ $row->tenloaitin }}</option>
												@endforeach
											</select>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" id="projectinput3" class="form-control" value="{{ $tintuc->tieude }}" name="txtTen">
										</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<img width="50%" src="upload/imgTinTuc/{{ $tintuc->img }}" />
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" id="projectinput3" class="form-control" value="{{ $tintuc->mota }}" name="txtMota">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											...
											<select id="issueinput5" name="txtTrangthai" class="form-control" data-toggle="tooltip"  data-trigger="hover" data-placement="top" data-title="Priority" >
												<option @if($tintuc->trangthai=='show') selected="" @endif value="show">HIỆN</option>
												<option @if($tintuc->trangthai=='hide') selected="" @endif value="hide">ẨN</option>
											</select>
										</div>
									</div>
								</div>
								<div class="form-group">
									...
									<textarea id="projectinput8" rows="5" class="ckeditor" name="txtNoidung" >{{ $tintuc->noidung }}</textarea>
								</div>
