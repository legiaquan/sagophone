			...
			<div class="card">
				...
				<div class="card-body">
					<div class="px-3">
                        ...
                        @endif
						<form class="form" action="admin/level/sua/{{ $level->id }}" method="POST">
							<input type="hidden" name="_token" value="{{ csrf_token() }}">
							<div class="form-body">
								<div class="form-body">
								<div class="form-group">
									<label for="issueinput1">Tên chức vụ</label>
									<input type="text" id="issueinput1" class="form-control"  name="txtTen" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Issue Title" value="{{ $level->tenlevel }}" placeholder="Vui lòng nhập tên chức vụ">
								</div>
							</div>
