			...
			<div class="container">
				...
				<div class="row">				
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							<div class="shop-img">
								<img width="250px" height="250px" src="upload/imgSanPham/6.jpg" alt="">
							</div>
							<div class="shop-body">
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							<div class="shop-img">
								<img width="250px" height="250px" src="upload/imgSanPham/1.jpg" alt="">
							</div>
							<div class="shop-body">
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							<div class="shop-img">
								<img width="250px" height="250px" src="upload/imgSanPham/product02.png" alt="">
							</div>
							<div class="shop-body">
									...
									<div class="products-slick" data-nav="#slick-nav-1">
										...
										<div class="product">
											<div class="product-img">
												<a href="chitiet/{{$sphd->id_sanpham}}"> 
											...
											<div class="product-body">
												...
												<h4 class="product-price">
													@if($sphd->phantramkhuyenmai != null)
													{{$sphd->gia * $sphd->phantramkhuyenmai / 100}}<del class="product-old-price">{{$sphd->gia}}
													@else
														{{$sphd->gia}}
													@endif
												</h4>
								...
								<div id="tab1" class="tab-pane active">
									<div class="products-slick" data-nav="#slick-nav-2">
										...
										<div class="product">
											...
											<div class="add-to-cart">
												<a style="color: white;font-weight: bolder;" href="{{route('add.shopping.cart',$spm->id)}}"><i class="fa fa-shopping-cart"></i>Thêm vào giỏ hàng</a>
											</div>
							...
							<div class="products-tabs">
								...
								<div id="tab2" class="tab-pane fade in active">
									<div class="products-slick" data-nav="#slick-nav-3">
										...
										<div class="product">
											<div class="product-img">
												<a href="chitiet/{{$spbc->id_sanpham}}"> 
											...
											<div class="add-to-cart">
												<a style="color: white;font-weight: bolder;" href="{{route('add.shopping.cart',$spbc->id)}}"><i class="fa fa-shopping-cart"></i>Thêm vào giỏ hàng</a>
											</div>
