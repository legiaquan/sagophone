                ...
                <div class="row">
                    <div style="display: table; margin: auto; height: 50px; text-align: center;">
                    	...
                    	@if($tinhtrang == "apending")
	                        ...
	                        <span class="step step_complete"> <a class="btn btn-default" style="opacity: 0.4">Đã Hủy</a> <span class="step_line "></span> <span class="step_line step_complete"> </span> </span>
